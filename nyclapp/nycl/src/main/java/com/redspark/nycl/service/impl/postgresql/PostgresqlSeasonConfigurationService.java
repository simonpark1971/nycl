...
import com.redspark.nycl.persistence.PostgresqlSeasonRepository;
...
public class PostgresqlSeasonConfigurationService implements SeasonConfigurationService {
  ...
  private static final String CURRENT_YEAR = Integer.toString(CALENDAR.get(Calendar.YEAR));
  ...
  public League getLeague(String season, AgeGroup ageGroup) {
    League league = new League(new LeagueConfiguration(ageGroup,
      new DivisionConfiguration(0, false, ageGroup)),
